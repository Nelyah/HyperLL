...
\author{Dequeker ChloÃ©, Ziat Ghiles}
\date{February 2015}
...
We will then introduce the Dense representation, which becomes more efficient when the number of index reaches a 
certain value we will be talking about in the next section. \\
...
In this section since this is mainly our personal point of view on the work we've done, we chose to do two separate section for each of us. The first of will be written by Chloé and the second one by Ghiles.
